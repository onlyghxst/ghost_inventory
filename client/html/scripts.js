...
$(document).ready(function () {
  ...
  document.onkeyup = function (data) {
    if (data.which == 27) {
      $.post('http://ghost_inventory/close', JSON.stringify({}));
    }
  };
...
function useItem() {
  ...
  if (amount == "0" || amount == "" || amount == null) {
    ...
    if(itemIdname) {
      $.post('http://ghost_inventory/useItem', JSON.stringify({
        idname: itemIdname,
        amount: amount
      }))
      .then(() => {
...
function dropItem() {
  ...
  if (amount == "0" || amount == "" || amount == null) {
    ...
    if(itemIdname !== null) {
      $.post('http://ghost_inventory/dropItem', JSON.stringify({
        idname: itemIdname,
        amount: amount
      }))
      .then(() => {
...
function giveItem() {
  ...
  if (amount == "0" || amount == "" || amount == null) {
    ...
    if(itemIdname) {
      $.post('http://ghost_inventory/giveItem', JSON.stringify({
        idname: itemIdname,
        amount: amount
      }))
      .then(() => {
